...
The 'databricks_ci_cd' project was generated by using the default-python template.
...
3. To deploy a development copy of this project, type:
    ...
    `[dev yourname] databricks_ci_cd_job` to your workspace.
...
4. Similarly, to deploy a production copy, type:
   ...
   (defined in resources/databricks_ci_cd.job.yml). The schedule
